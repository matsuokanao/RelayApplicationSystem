...
struct ManagerAnswercreateGame: View {
    @State var ManagerCreateOnBoard = [Board(title: "試合を作成したい！",
                                             detail: "まず「大会関係者専用ページ」の「試合を作成する」を開いて下さい。",
                                             pic: "manager2"),
                                       
                                       Board(title: "試合内容を記入しよう！",
                                             detail:"「試合作成」ページにて試合を作成する団体の「団体番号」と「団体パスワード」を入力し、試合内容を入力して下さい。内容に不備が無いか確認し「登録」ボタンを押しましょう。試合の作成が完了しました！",
                                             pic: "manager3"),
