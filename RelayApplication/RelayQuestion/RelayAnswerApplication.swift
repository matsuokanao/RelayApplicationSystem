...
struct RelayAnswerApplication: View {
    @State var RelayApplicationonBoard = [Board(title: "リレーに申し込もう！",
                                                detail: "まず「リレー」ページの「リレーに申し込む」を開いて下さい。",
                                                pic: "relay1"),
                                          
                                          Board(title: "試合を選ぼう！",
                                                detail: "出場したい試合の都道府県を入力し、試合を選びましょう。",
                                                pic: "relay2"),
                                          
                                          Board(title: "必要項目を入力しよう！",
                                                detail: "試合を選択し、画面の空欄をお手本通りに記入しましょう。ユーザーパスとメールアドレスは当日オーダーを提出する人物の情報を記入しましょう。全ての項目を記入した後「確認する」ボタンを押して下さい。",
                                                pic: "relay3"),
                                          
                                          Board(title: "確認しよう！",
                                                detail: "最後に確認画面です。入力した内容に不備がないか確認し、「申し込み」ボタンを押しましょう。以上でリレーの申し込みが完了となります。",
                                                pic: "relay4"),
    ]
