...
struct GameAnswerEnd: View {
    @State var GameEndOnBoard = [Board(title: "試合が終了したら？",
                                       detail:"「試合画面」にて「試合申し込みリスト」を開きましょう。",
                                       pic: "game6"),
                                 
                                 Board(title: "終了させたい試合を選ぼう！",
                                       detail:"「試合申し込みリスト」にて試合申し込み時に記入した「ユーザーパス」と「メールアドレス」を入力して下さい。試合リストが表示されます。終了させたい試合を選びましょう！",
                                       pic: "game7"),
                                 
                                 Board(title: "試合を終了させよう！",
                                       detail: "試合を選択し、画面右上の「終了した試合ですか？」を押して下さい。試合が終了します。",
                                       pic: "game14"),
                                 
                                 Board(title: "終了した試合を見たい！",
                                       detail: "「試合申し込みリスト」の「終了した試合一覧」画面にて内容を確認できます。",
                                       pic: "game13"),
    ]
