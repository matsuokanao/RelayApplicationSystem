...
struct ManagerAnswerGameEndFlow: View {
    @State var ManagerGameEndFlowOnBoard = [Board(title: "大会を終了させよう！",
                                                  detail: "試合を終了させ流ことによって試合が「終了した試合一覧」リストに移動します。「大会関係者専用ページ」の「試合のエントリーリスト」を開いて下さい。",
                                                  pic: "manager8"),
                                            
                                            Board(title: "試合終了画面に移動しよう！",
                                                  detail: "「エントリーリスト」画面の試合を終了させるボタンを押して下さい。",
                                                  pic: "manager9"),
                                            
                                            Board(title: "完了！",
                                                  detail: "「運営団体番号」と「運営団体パスワード」を記入し終了させたい試合を選んでください。試合が終了します！",
                                                  pic: "manager10"),
    ]
