...
struct GameAnswerApplicationShow: View {
    @State var GameShowOnBoard = [Board(title: "試合を確認しよう！",
                                        detail: "「試合画面」にて「試合申し込みリスト」を開きましょう。",
                                        pic: "game6"),
                                  
                                  Board(title: "試合リストを確認しよう！",
                                        detail: "「試合申し込みリスト」にて試合申し込み時に記入した「ユーザーパス」と「メールアドレス」を入力して下さい。試合リストが表示されます。内容を確認したい試合を選びましょう！",
                                        pic: "game7"),
                                  
                                  Board(title: "内容を確認しよう！",
                                        detail: "選択した試合の内容が確認できます！",
                                        pic: "game8"),
    ]
