...
struct GameAnswerDiaryDelete: View {
    @State var GameDiaryDeleteOnBoard = [Board(title: "試合日記を開こう！",
                                               detail: "試合日記ページの「試合一覧」ボタンを押しましょう。",
                                               pic: "game10"),
                                         
                                         Board(title: "削除したい日記を選ぼう！",
                                               detail: "項目を入力し削除した日記を選択して下さい。",
                                               pic: "game11"),
                                         
                                         Board(title: "日記を削除しよう！",
                                               detail: "画面の一番下にある「この日記を削除する」ボタンを押して下さい。日記に削除が完了します！",
                                               pic: "game12"),
    ]
