...
struct GameAnswerApplication: View {
    @State var GameApplicationonBoard = [Board(title: "まずはユーザー登録！",
                                               detail: "まず試合に申し込む前に「HOME画面」にてユーザー登録を行って下さい。その際に「ユーザーパス」を記入しますが、試合登録の際に必要になりますので忘れないようにして下さい。",
                                               pic: "game1"),
                                         
                                         Board(title: "試合に申し込もう！",
                                               detail: "次に「試合画面」にて試合申し込みを行いましょう。「申し込む」をクリックして下さい。",
                                               pic: "game2"),
                                         
                                         Board(title: "試合を探そう！",
                                               detail: "出場したい試合の開催都道府県を記入し試合を探しましょう。",
                                               pic: "game3"),
                                         
                                         Board(title: "出場種目を記入しよう！",
                                               detail: "試合を選択し、画面の空欄をお手本通りに記入しましょう。ユーザーパスとメールアドレスは試合を申し込む本人の情報を記入しましょう。全ての項目を記入した後「確認する」ボタンを押して下さい。",
                                               pic: "game4"),
                                         
                                         Board(title: "確認しよう！",
                                               detail: "最後に確認画面です。入力した内容に不備がないか確認し、「申し込み」ボタンを押しましょう。以上で試合申し込みが完了となります。",
                                               pic: "game5"),
    ]
