...
struct ManagerAnswer: View {
    @State var ManagerOnBoard = [Board(title: "運営団体情報とは？",
                                       detail: "試合作成、運営時に必要となる運営情報です。お申し込みをした代表者1名が書類の指示に沿って内容をご記入し、団体内で情報を共有して下さい。「運営団体パスワード」と「運営団体番号」は必要になりますので忘れないようにご注意下さい。",
                                       pic: "manager1"),
