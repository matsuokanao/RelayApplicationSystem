...
struct RelayAnswerApplicationEnd: View {
    @State var RelayEndOnBoard = [Board(title: "試合が終了したら？",
                                        detail: "「リレー画面」にて「リレーの申し込みリスト」を開きましょう。",
                                        pic: "relay5"),
                                  
                                  Board(title: "終了させたい試合を選ぼう！",
                                        detail: "「リレーの申し込みリスト」にてリレー申し込み時に記入した「ユーザーパス」と「メールアドレス」を入力して下さい。リレーリストが表示されます。終了させたい試合を選びましょう！",
                                        pic: "relay6"),
                                  ...
                                  Board(title: "終了した試合を見たい！",
                                        detail: "「リレーの申し込みリスト」の「終了した試合一覧」画面にて内容を確認できます。",
                                        pic: "relay12"),
    ]
